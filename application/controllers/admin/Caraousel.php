...
class Caraousel extends CI_Controller {
    ...
    public function simpan(){
        ...
        if($_FILES['foto']['size'] >= 500 * 1024){
            $this->session->set_flashdata('alert', '
                ...
                The photo size is too large, re-upload the photo with a size of less than 500 KB
        ...
        $this->session->set_flashdata('alert', '<div class="alert alert-dark" ro1le="alert">
    ...
    public function delete_data($id){
        ...
        $this->session->set_flashdata('alert', '<div class="alert alert-dark" role="alert">
        Successfully delete caraousel
        </div>');
        redirect('admin/caraousel');
    }
